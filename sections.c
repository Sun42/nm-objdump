...
** Last update Sun Mar  1 22:09:11 2009 christophe sundas
*/
#ifdef sun
# include <libelf.h>
#endif
...
*/
char	*get_sect_name(Elf32_Shdr *sect, Elf32_Shdr *sctnm, char *buf)
{
  char	*name;

  name = (char *) ((unsigned int) buf + sctnm->sh_offset + 1 + sect->sh_name);
  return (name);
}
